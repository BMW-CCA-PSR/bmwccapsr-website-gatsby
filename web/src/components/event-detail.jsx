    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Heading variant="styles.h3" sx={{ pb: 3 }}>
              Details
            </Heading>
            ...
            {props.poc && (
              <Heading variant="styles.h4">Point of Contact</Heading>
            )}
            {props.poc
              ? props.poc.name && (
                  <Text variant="styles.p">{props.poc.name}</Text>
                )
              : null}
            {props.poc
              ? props.poc.contact && (
                  <Text variant="styles.p">{props.poc.contact}</Text>
                )
              : null}
          </Flex>
          <Flex
          ...
          >
            {isOnline ? (
              <>
                ...
                {props.onlineLink && (
                  <Heading variant="styles.h4">Link</Heading>
                )}
                {props.onlineLink && (
                  <Text
                    variant="styles.p"
              ...
              <>
                ...
                {props.venueName && (
                  <Text variant="styles.p">{props.venueName}</Text>
                )}
                ...
                {address.line2 && (
                  <Text variant="styles.p">{address.line2}</Text>
                )}
                ...
                {props.website && (
                  <Heading variant="styles.h4">Website</Heading>
                )}
                {props.website && (
                  <Text
                    variant="styles.p"
